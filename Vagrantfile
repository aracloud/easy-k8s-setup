...
os_nodes_master_pb= "files/master-playbook-ubuntu.yml"
os_nodes_worker_pb= "files/worker-playbook-ubuntu.yml"
os_rke= "generic/ubuntu2004"
os_rke_pb= "files/rke-playbook.yml"

# RKE vars 
rke_version_vag= "v1.2.4"
rke_install_dir_vag= "/usr/local/bin"
rke_config_file_vag= "files/rancher-cluster.yml"
