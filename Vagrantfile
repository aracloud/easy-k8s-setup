...
masters = {
   "uk8s1" => ["generic/ubuntu1804", 2, 3072, 30, "master-playbook.yml", "192.168.2.121" ],
}

workers = {
   "uk8s2" => ["generic/ubuntu1804", 2, 3072, 30, "worker-playbook.yml", "192.168.2.122" ],
   "uk8s3" => ["generic/ubuntu1804", 2, 3072, 30, "worker-playbook.yml", "192.168.2.123" ],
}
